...
app.get('/', (req, res) => {
  res.json({ 
    message: '✅ DzMarket SaaS Platform v3.0.0',
    status: 'running',
    timestamp: new Date()
  });
});
...
app.get('/api/public/settings', async (req, res) => {
  try {
    res.json({
      seo: {
        title: 'DzMarket - منصة التجارة الإلكترونية',
        description: 'منصة SaaS متكاملة لإنشاء متاجر إلكترونية احترافية',
...
app.listen(PORT, () => {
  console.log(`🚀 DzMarket SaaS Server running on port ${PORT}`);
